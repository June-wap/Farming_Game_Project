...
public class TimeManager : MonoBehaviour
{
    ...
    private bool _isPaused = true; // Ban đầu tạm dừng cho đến khi đăng nhập thành công
    ...
    // ─── TÍNH NĂNG ĐI NGỦ (BỎ QUA THỜI GIAN ĐẾN NGÀY MỚI) ─────────
    public void SkipToNextDay()
    {
        ...
        // Kích hoạt sự kiện ngày mới để mọc cây cỏ
        OnNewDayStarted?.Invoke();
        
        // Lưu tiến độ lên Firebase
        UserDataManager.Instance?.SyncDay(_currentDay);

        Debug.Log($"[TimeManager] Zzz... ĐÃ NGỦ QUA ĐÊM! Ngày mới bắt đầu: {_currentDay}");
    }
